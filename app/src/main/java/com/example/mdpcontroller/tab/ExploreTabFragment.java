...
public class ExploreTabFragment extends Fragment {
    ...
    private AppDataModel appStateViewModel;
...
//    OnDataPass dataPasser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        appStateViewModel = new ViewModelProvider(requireActivity()).get(AppDataModel.class);
...
//            tabBtnClick(isSetRobot);
            ...
            appStateViewModel.setIsSetRobot(isSetRobot);
        });
        setObstaclesBtn.setOnClickListener(item ->{
            ...
            appStateViewModel.setIsSetObstacles(isSetObstacles);
        });
